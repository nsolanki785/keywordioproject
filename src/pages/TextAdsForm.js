                ...
                <Box  sx={{padding:'20px', border: '1px solid', borderColor: '#424242',margin: '90px', bgcolor: '#FFFFFF' }}>
                    ...
                    onSubmit={ handleSubmit}>
                        <Grid container xs={12} item spacing={2} sx={{marginTop:'2px',padding:'5px'}}>
                            ...
                            <Grid item xs={3} md={4} sx={{marginTop:'5px'}}>
                                <Stack>
                                    <Input
                            ...
                            <Grid item xs={3} md={4} sx={{marginTop:'5px'}}>
                                <Stack>
                                    <Input
                                        ...
                                        value={values.portrait_marketing_image}
                                        onChange={handleChange}
                                                onBlur={handleBlur}
                                    />
                                </Stack>
                            ...
                            <Grid item xs={3} md={4} sx={{marginTop:'5px'}}>
                                <Stack>
                                    <Input
                                        ...
                                        value={values.square_marketing_image}
                                        onChange={handleChange}
                                                onBlur={handleBlur}
                                    />
                                </Stack>
                            </Grid>
                            <Grid item xs={3} md={12}sx={{marginTop:'5px'}}>
                                <Stack>
                                    <Input
                                        label="Video URL"
